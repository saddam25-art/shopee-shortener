...
def main():
    ...
    # Update ecosystem file with all required env vars
    print("=== Updating PM2 ecosystem with all env vars ===")
  ...
  apps: [{
    ...
    env: {
      ...
      AUTH_JWT_SECRET: 'saddam-shortlink-auth-jwt-secret-2025',
...
"""
    ...
    run_command(ssh, """curl -s -X POST http://localhost:8080/api/auth/register \\
        ...
        -d '{"username":"testuser2","email":"test2@test.com","password":"test123456"}'""")
